                    ...
                    <div style="overflow: auto">
                            <div class="wthree">
                                ...
                                <div class="col-md-6 wthree-left wow fadeInDown" style=" padding-right: 10px" data-wow-duration=".8s"
                                    ...
                                    <div class="soci">
                                        <ul>
                                            <li class="hvr-rectangle-out tyFlags upDown" title="${p.id}" style="display:inline-block;"><a class="fb"  href="#">上</a></li>
                                            <li class="hvr-rectangle-out tyFlags"><a class="goog" href="editBlog?id=${p.id}">修</a></li>
                                            <li class="hvr-rectangle-out tyFlags"><a class="fb" href="deleteBlog?id=${p.id}&userId=${p.userId}">删</a></li>
                                        </ul>
                                    </div>
